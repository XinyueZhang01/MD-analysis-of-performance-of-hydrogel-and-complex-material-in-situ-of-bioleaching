...
u = Universe(r'D:\XinyueZhang\DE3\UIUX\Model.data')
filename   = r'D:\XinyueZhang\DE3\UIUX\Model.data'
...
with open(r"D:\XinyueZhang\DE3\UIUX\Polynylon60chains.data".format(n),'w')as LAMMPS:
